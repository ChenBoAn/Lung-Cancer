...
pred_path = "E:/Lung_Cancer/Paper/Compare_Dynamic_Threshold/OTSU/"
answer_path = "G:/Hospital_data/nodule/final/mask/"
save_erode1_path = "E:/Lung_Cancer/Paper/Compare_Dynamic_Threshold/OTSU_Image_Processing/erode1/"
save_remove_path = "E:/Lung_Cancer/Paper/Compare_Dynamic_Threshold/OTSU_Image_Processing/remove/"
save_erode2_path = "E:/Lung_Cancer/Paper/Compare_Dynamic_Threshold/OTSU_Image_Processing/erode2/"
save_dilate_path = "E:/Lung_Cancer/Paper/Compare_Dynamic_Threshold/OTSU_Image_Processing/dilate/"

df_erode1 = pd.DataFrame(columns=["patient_id", "nodule_no", "image_no", "dice", "coverage", "precision", "f-measure"])
df_remove = pd.DataFrame(columns=["patient_id", "nodule_no", "image_no", "dice", "coverage", "precision", "f-measure"])
df_erode2 = pd.DataFrame(columns=["patient_id", "nodule_no", "image_no", "dice", "coverage", "precision", "f-measure"])
...
with pd.ExcelWriter(engine='openpyxl', path='E:/Lung_Cancer/Paper/Compare_Dynamic_Threshold/OTSU_Image_Processing/result.xlsx', mode='a') as writer:
...
with pd.ExcelWriter(engine='openpyxl', path='E:/Lung_Cancer/Paper/Compare_Dynamic_Threshold/Total_Compare_180.xlsx', mode='a') as writer:
    df_dilate.to_excel(writer, sheet_name='OTSU_IP', index=False)