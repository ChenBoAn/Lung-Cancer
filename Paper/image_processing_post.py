...
for n in range(1, 7):
    pred_path = "E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/2/threshold" + str(n) + "/"
    answer_path = "G:/Hospital_data/nodule/final/mask/"
    save_erode_path = "E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/2/post" + str(n) + "/erode/"
    save_remove_path = "E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/2/post" + str(n) + "/remove/"
    save_dilate_path = "E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/2/post" + str(n) + "/dilate/"
    ...
    with pd.ExcelWriter(engine='openpyxl', path='E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/2/result/post' + str(n) + '.xlsx', mode='a') as writer:
    ...
    with pd.ExcelWriter(engine='openpyxl', path='E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/2/result/post_result.xlsx', mode='a') as writer:
        df_dilate.to_excel(writer, sheet_name=str(n), index=False)