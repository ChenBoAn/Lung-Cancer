...
levelset_predict_path = "E:/Lung_Cancer/Paper/Compare_Dynamic_Threshold/Level_Set/"
...
with pd.ExcelWriter(engine='openpyxl', path='E:/Lung_Cancer/Paper/Compare_Dynamic_Threshold/Total_Compare.xlsx', mode='a') as writer:
    df.to_excel(writer, sheet_name='Level_Set', index=False)