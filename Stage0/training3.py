...
reload_model = tf.keras.models.load_model('C:/VS_Code/training_H/model/classify1.h5')
x_list = list() # 存所有影像的array
y_list = list() # 存所有名稱的 array
x_test = list()
y_test = list()

path = 'C:/VS_Code/training_H/test_category1/1/'
...
plt.savefig('C:/VS_Code/training_H/test_person_outcome1/1.png', dpi=fig.dpi, bbox_inches='tight', pad_inches = 0)
