...
path = '/home/a1095557/training_H/category2/'
...
保存資料
"""
np.save('/home/a1095557/training_H/data/x_list2', x_list) 
np.save('/home/a1095557/training_H/data/y_list2', y_list)
...
train_history = model.fit(x_train, y_train, 
          batch_size=32, #每次更新的樣本數，若為None為32 
...
"""
model.save('/home/a1095557/training_H/model/classify2.h5') #儲存模型
