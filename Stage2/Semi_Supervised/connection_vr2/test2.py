...
def main():
    ...
    for patient_id in range(1, 201):
        ...
        if os.path.isdir("G:/Hospital_data/nodule/partial/mask/" + str(patient_id).zfill(3) + "/"):
            ...
            nodule_path = "E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/threshold2/test3/" + str(patient_id) + "/"
    ...
    with pd.ExcelWriter(engine='openpyxl', path='E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/result/threshold2.xlsx', mode='a') as writer:
        df.to_excel(writer, sheet_name='test3', index=False)
