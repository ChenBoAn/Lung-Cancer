...
save_erode_path = "E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/2/test5/erode/"
save_remove_path = "E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/2/test5/remove/"
save_dilate_path = "E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/2/test5/dilate/"
...
for i in sorted(os.listdir(pred_path)):
    ...
    for j in sorted(os.listdir(pred_file_path)):
        ...
        for k in sorted(os.listdir(pred_file)):
            ...
            df_erode.loc[len(df_erode.index)] = [int(i), int(j), int(k[:-4]), round(final_dice, 3), round(final_coverage, 3), round(final_precision, 3)]
...
with pd.ExcelWriter(engine='openpyxl', path='E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/2/result/test5.xlsx', mode='a') as writer:
