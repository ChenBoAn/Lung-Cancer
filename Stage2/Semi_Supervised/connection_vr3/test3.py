...
save_path1 = "E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/3/test1/"
save_path2 = "E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/3/test2/"
...
for i in sorted(os.listdir(predict_path)):
    ...
    for j in sorted(os.listdir(file_path1_1)):
        ...
        for k in sorted(os.listdir(file_path1_2)):
            ...
            cv2.imwrite(save_path1_2 + k, final1)
            cv2.imwrite(save_path2_2 + k, final2)
            
            dice1 = dice(answer_image / 255., final1 / 255.)
            coverage1 = coverage(answer_image / 255., final1 / 255.)
            precision1 = precision(answer_image / 255., final1 / 255.)
            
            dice2 = dice(answer_image / 255., final2 / 255.)
            coverage2 = coverage(answer_image / 255., final2 / 255.)
            precision2 = precision(answer_image / 255., final2 / 255.)
