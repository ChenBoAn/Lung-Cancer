...
pred_path = "E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/2/threshold6/"
answer_path = "G:/Hospital_data/nodule/final/mask/"
save_erode1_path = "E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/3/test8/erode1/"
save_remove_path = "E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/3/test8/remove/"
save_erode2_path = "E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/3/test8/erode2/"
save_dilate_path = "E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/3/test8/dilate/"
...
for i in sorted(os.listdir(pred_path)):
    ...
    for j in sorted(os.listdir(pred_file_path)):
        ...
        for k in sorted(os.listdir(pred_file)):
            ...
            df_remove.loc[len(df_remove.index)] = [int(i), int(j), int(k[:-4]), round(final_dice, 3), round(final_coverage, 3), round(final_precision, 3)]
...
with pd.ExcelWriter(engine='openpyxl', path='E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/3/result/test8.xlsx', mode='a') as writer:
