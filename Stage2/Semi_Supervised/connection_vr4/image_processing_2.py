...
save_erode_path = "E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/4/threshold_GP_IP_3/erode/"
save_remove_path = "E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/4/threshold_GP_IP_3/remove/"
save_dilate_path = "E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/4/threshold_GP_IP_3/dilate/"

df_erode = pd.DataFrame(columns=["patient_id", "nodule_no", "image_no", "dice", "coverage", "precision", "f_measure"])
...
with pd.ExcelWriter(engine='openpyxl', path='E:/Lung_Cancer/Lung_Nodule_Segmentation/final3/4/result/threshold_GP_IP_3.xlsx', mode='a') as writer:
